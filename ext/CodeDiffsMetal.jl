...
CodeDiffs.cleanup_code(::Val{:mtl_typed},  c, dbinfo, cleanup_opts) = CodeDiffs.cleanup_code(Val{:gpu_typed}(), c, dbinfo, cleanup_opts)
CodeDiffs.cleanup_code(::Val{:mtl_llvm},   c, dbinfo, cleanup_opts) = CodeDiffs.cleanup_code(Val{:gpu_llvm}(), c, dbinfo, cleanup_opts)
CodeDiffs.cleanup_code(::Val{:mtl_native}, c, dbinfo, cleanup_opts) = CodeDiffs.cleanup_code(Val{:agx}(), c, dbinfo, cleanup_opts)
